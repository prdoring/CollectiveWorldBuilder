...
from apis.sqldb import get_user_fact_count, get_or_create_conversation, get_all_proper_nouns, get_user_conversations
...
def on_connect_emitters(user_id, world_id):
    ...
    if(not has_database_conversation):
        ...
        get_or_create_conversation(Config.DATABASE_AGENT_NAME, user_id, welcome_message, world=world_id)
        existing_conversations = get_user_conversations(user_id, world_id)
